...
onready var startbutton = $MarginContainer/VBoxContainer/ButtonContainer/PlayPanel/PlayLabel
onready var storybutton = $MarginContainer/VBoxContainer/ButtonContainer/StoryPanel/StoryLabel
onready var creditsbutton = $MarginContainer/VBoxContainer/ButtonContainer/CreditsPanel/CreditsLabel
var fliprate = 0.1
onready var topl = $MarginContainer/VBoxContainer/GraphicBox/PlayerSprite1
onready var topr = $MarginContainer/VBoxContainer/GraphicBox/PlayerSprite2
